...
export default function ResultDisplay({ 
    ...
    if (navigator.share) {
      try {
        ...
        await navigator.share({
          ...
          text: "Check out my post-apocalyptic nurse transformation from #LastNurses",
          files: [file]
        }).then(() => {
  ...
  const handleTwitterShare = () => {
    ...
    // Updated text that works better for Twitter/X
    const twitterText = encodeURIComponent("Check out my post-apocalyptic nurse transformation from #LastNurses");
